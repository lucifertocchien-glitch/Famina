    ...
    <div class="container p-4">
        ...
        <form action="{{ route('suppliers.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input name="TenNV" class="form-control @error('TenNV') is-invalid @enderror" value="{{ old('TenNV') }}">
                @error('TenNV')
            ...
            <div class="mb-3">
                ...
                <input name="TaiKhoan" class="form-control @error('TaiKhoan') is-invalid @enderror" value="{{ old('TaiKhoan') }}">
                @error('TaiKhoan')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input name="SDT" class="form-control @error('SDT') is-invalid @enderror" value="{{ old('SDT') }}">
                @error('SDT')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input name="MaTL" class="form-control @error('MaTL') is-invalid @enderror" value="{{ old('MaTL') }}">
                @error('MaTL')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
